                            ...
                            <div class="well">
                                <c:choose>
                                    <c:when test="${person.permission==1}">
                                        <ul class="pager">
                                            ...
                                            <li class="next bigger-120">
                                                <a href="activity_setting?id=${activity.id}"><i
                                    ...
                                    <c:when test="${person.permission==2}">
                                        <ul class="pager">
                                            <c:if test="${activity.system.id==person.system.id && activity.state!=0 && activity.editor.system.id==person.system.id}">
                                                <li class="next bigger-120">
                                                    <a href="activity_setting/${activity.id}"><i
                                                            class="ace-icon fa fa-pencil"></i> 修改</a>
                                                </li>
                                            </c:if>
                                            <li class="previous bigger-120">
                                ...
                                <div class="col-md-10"
                                    ...
                                    <h2 class="blue center">${activity.title}</h2>
                                </div>

                                <h5 class="publish">
                                    <span>来源&nbsp;:&nbsp;${activity.system.sysName}</span> &nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <span>编辑人&nbsp;:&nbsp;${activity.editor.name}</span> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;
                                    <span>时间&nbsp;:&nbsp;${activity.time}</span>&nbsp;<span>${activity.date}</span>
                                </h5>
                                <hr/>
                                <div class="col-md-11"
                                     style="float: none;display: block;margin-left: auto;margin-right: auto;">
                                    <div class="space"></div>
                                    <%--<div class="widget-main">${activity.content}</div>--%>
