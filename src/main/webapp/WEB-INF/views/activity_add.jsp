            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form:form
                                id="sample-form"
                                action="${pageContext.request.contextPath}/activity_save"
                            ...
                            <fieldset>
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <c:choose>
                                        <c:when test="${activity.id ne 0}">
                                            <div class="col-xs-12 col-sm-5">
										<span class="block input-icon input-icon-right">
                                            <input type="text" class="width-100 " value="${activity.editor.name}"
                                                   disabled/>
                                            <form:input type="hidden" id="inputSuccess" class="width-100"
                                                        path="editor.id" value="${activity.editor.id}"/> <i
                                ...
                                <c:choose>
                                    <c:when test="${activity.fileId ==''||activity.fileId ==null}">
                                        <div class="form-group has-success">
                                            <label for="inputSuccess"
...
<script src="assets/js/atits-js/activity_add.js"></script>
