					...
					<div class="col-xs-12">
						...
						<div>
							<table class="table table-striped table-bordered">
								<thead>
								<tr>
									<th class="tb_th">功能研究室</th>
									<th class="hidden-xs tb_th">建设依托单位</th>
									<th class="hidden-480 tb_th">研究室主任</th>
								...
								<c:forEach items="${laboratorys}" var="laboratory">
									<c:if test="${laboratory.state == 1}">
									<tr>
										<td><a href="laboratory_detail?id=${laboratory.id}">${laboratory.labName}</a></td>
										<td class="hidden-xs">${laboratory.company}</td>
										<td class="hidden-480 text-center">${laboratory.manager}</td>
									</tr>
									</c:if>
								</c:forEach>
								</tbody>
						...
						<div class="row">
							<div class="col-sm-5 pull-right">
								<h4 class="pull-right">
									功能研究室数 : <span class="red">${laboratoryNum}</span>
								</h4>
							</div>
						</div>
