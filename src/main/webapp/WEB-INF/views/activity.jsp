...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12">
            <table id="example" class="display table tab-content" style="width:100%">
                <thead>
                <tr>
                    <th>Name</th>
                    <th>Office</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("div.toolbar").html('<a href="activity_add" class="btn btn-primary btn-sm margin-1" role="button">添加</a><a href="#" class="btn btn-danger btn-sm margin-1" role="button">删除</a>');
    });
</script>
