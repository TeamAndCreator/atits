...
<head>
    ...
    <meta charset="utf-8"/>
    <title>重大活动</title>
    <meta name="description" content="Static &amp; activity Tables"/>
    <meta name="viewport"
                        ...
                        <c:choose>
                            <c:when test="${person.permission ==1}">
                                <div class="action-buttons">
                                    <a class="btn btn-sm btn-primary" href="activity_add"> <i
                                        ...
                                        <tr>
                                            <td class="center col-md-1 subcheck"><label
                                                    class="position-relative"> <input type="checkbox"
                                                                                      ...
                                                                                      value="${activity.id}"/> <span
                                                    class="lbl"></span>
                                            </label></td>

                                            <td><a href="activity_detail?id=${activity.id}" role="button"
                            ...
                            <c:when test="${person.permission ==2}">
                                ...
                                <table id="sample-table-1" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach items="${activitys}" var="activity">
                                        <c:if test="${activity.state==1 || activity.system.id==person.system.id && activity.editor.system.id==person.system.id}">
                                            <tr>
                                                <c:choose>
                                                    <c:when test="${activity.system.id==person.system.id && activity.state!=0 && activity.editor.system.id==person.system.id}">
                                                        <td class="center col-md-1 subcheck"><label
                                                                class="position-relative"> <input type="checkbox"
                                                                                                  class="ace"
                                                                                                  name="subcheck"
                            ...
                            <c:otherwise>
                                <table id="sample-table-3" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach items="${activitys}" var="activity">
                                        <c:if test="${activity.state == 1 && activity.system.id==1 || activity.state == 1 && activity.system.id == person.system.id}">
                                            <tr>
                                                <td></td>
                                                <td><a href="activity_detail?id=${activity.id}" role="button"
                                                       class="blue" data-toggle="modal">${activity.title}</a>
...
<!-- 引入js -->
<script src="assets/js/atits-js/activity.js"></script>
</body>
</html>
