...
<head>
    ...
    <meta charset="utf-8"/>
    <title>重大成果</title>
    <meta name="description" content="Static &amp; report Tables"/>
    <meta name="viewport"
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <div class="row">
                    <div class="col-xs-12">
                        <h1 class="header smaller lighter blue">重大文件报告</h1>
                        <br/>
                        <!-- PAGE CONTENT BEGINS -->
                        <c:choose>
                            <c:when test="${person.permission ==1}">
                                <div class="action-buttons">
                                    <a class="btn btn-sm btn-primary" href="report_add"> <i
                                        ...
                                        <tr>
                                            <td class="center col-md-1 subcheck"><label
                                                    class="position-relative"> <input type="checkbox"
                                                                                      ...
                                                                                      value="${report.id}"/> <span
                                                    class="lbl"></span>
                                            </label></td>

                                            <td><a href="report_detail?id=${report.id}" role="button"
                                                   class="blue" data-toggle="modal">${report.title}</a>
                                            </td>
                                            <td>${report.system.sysName}</td>
                                            <td>${report.time}</td>
                            ...
                            <c:when test="${person.permission ==2}">
                                ...
                                <table id="sample-table-1" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach items="${reports}" var="report">
                                        <c:if test="${report.state==1 || report.system.id==person.system.id && report.editor.system.id==person.system.id}">
                                            <tr>
                                                <c:choose>
                                                    <c:when test="${report.system.id==person.system.id && report.state!=0 && report.editor.system.id==person.system.id}">
                                                        <td class="center col-md-1 subcheck"><label
                                                                class="position-relative"> <input type="checkbox"
                                                                                                  class="ace"
                                                                                                  name="subcheck"
                            ...
                            <c:otherwise>
                                <table id="sample-table-3" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach items="${reports}" var="report">
                                        <c:if test="${report.state == 1 && report.system.id==1 || report.state == 1 && report.system.id == person.system.id}">
                                            <tr>
                                                <td></td>
                                                <td><a href="report_detail?id=${report.id}" role="button"
                                                       class="blue" data-toggle="modal">${report.title}</a>
...
<!-- 引入js -->
<script src="assets/js/atits-js/report.js"></script>
</body>
</html>
