            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form:form
                                id="sample-form"
                                action="${pageContext.request.contextPath}/report_save"
                                method="post" class="form-horizontal"
                                modelAttribute="report">
                            <fieldset>
                                <c:if test="${report.id != 0}">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <c:choose>
                                        <c:when test="${report.id ne 0}">
                                            <div class="col-xs-12 col-sm-5">
										<span class="block input-icon input-icon-right">
                                            <input type="text" class="width-100 " value="${report.editor.name}"
                                                   disabled/>
                                            <form:input type="hidden" id="inputSuccess" class="width-100"
                                                        path="editor.id" value="${report.editor.id}"/> <i
                                ...
                                <c:choose>
                                    <c:when test="${report.fileId ==''||report.fileId ==null}">
                                        <div class="form-group has-success">
                                            <label for="inputSuccess"
...
<script src="assets/js/atits-js/report_add.js"></script>
