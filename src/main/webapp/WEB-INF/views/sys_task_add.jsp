			...
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					<li><i class="ace-icon fa fa-home home-icon"></i> <a
						href="index">首页</a></li>
					<li><a href="sys_task?sysId=${taskNum.sysId}">体系任务</a></li>
			...
			<div class="page-content">
				<div class="page-content-area">
					...
					<div class="row">
						<div class="col-xs-12">
							<!-- PAGE CONTENT BEGINS -->
							<form:form action="${pageContext.request.contextPath}/sys_task_save"
								...
								<div class="form-group has-warning">
									<label for="inputWarning"
										class="col-xs-12 col-sm-3 control-label no-padding-right">合同名称</label>
								...
								<div class="form-group has-success">
									<label for="inputInfo"
										   class="col-xs-12 col-sm-3 control-label no-padding-right">所属体系</label>
									<div class="col-xs-12 col-sm-5">
										<form:select class="form-control" path="system.id" id="system" >
											<form:option value="0" >--请选择--</form:option>
											<c:forEach items="${systems}" var="system">
												<c:if test="${system.id!=1}">
													<form:option value="${system.id}" chief="${system.chief}" class="sysName">${system.sysName}</form:option>
												</c:if>
											</c:forEach>
										</form:select>
									</div>
								...
								<div class="form-group has-success">
									<label for="inputSuccess"
										   class="col-xs-12 col-sm-3 control-label no-padding-right">负责人</label>
									<div class="col-xs-12 col-sm-5">

										<form:select class="form-control" path="bearer.id" id="bearer">
											<c:if test="${task.id ne 0}">
												<form:option value="${task.bearer.id}">${task.bearer.name}</form:option>
											</c:if>
										</form:select>
									...
									<%--<div class="col-xs-12 col-sm-5">--%>
										<%--<span class="block input-icon input-icon-right"> <form:input--%>
												<%--type="text" id="inputWarning" class="width-100" path="bearer" />--%>
											<%--<i class="ace-icon fa fa-leaf"></i>--%>
										<%--</span>--%>
									<%--</div>--%>
								</div>
								...
								<div class="form-group has-info">
									...
									<div class="col-xs-12 col-sm-5">
										<span class="block input-icon input-icon-right"> <form:input
												...
												path="startDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d'})"/>
								...
								<div class="form-group has-info">
									...
									<div class="col-xs-12 col-sm-5">
										<span class="block input-icon input-icon-right"> <form:input
												type="text" id="inputSuccess" name="HBegtime" style="width: 90%" class="width-100 "
												path="endDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d'})"/>
								...
								<c:choose>
									<c:when test="${task.fileId ==''||task.fileId ==null}">
										<div class="form-group has-success">
											<label for="inputSuccess"
												   class="col-xs-12 col-sm-3 control-label no-padding-right">上传文件</label>
											<div class="col-xs-12 col-sm-5  ">
							...
							<div class="col-md-11 col-lg-10" style=" float: none;display: block;margin-left: auto;margin-right: auto;  ">
								...
								<h4 class="header blue clearfix">合同内容</h4>
								...
								<form:input type='hidden' path='state' value='1' />
...
<![endif]-->
	...
	<script src="assets/js/atits-js/sys_task_add.js"></script>
</body>
</html>
