            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form:form
                                id="sample-form"
                                action="${pageContext.request.contextPath}/notice_save"
                            ...
                            <fieldset>
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <c:choose>
                                        <c:when test="${notice.id ne 0}">
                                            <div class="col-xs-12 col-sm-5">
										<span class="block input-icon input-icon-right">
                                            <input type="text" class="width-100 " value="${notice.editor.name}"
                                                   disabled="true"/>
                                            <form:input type="hidden" id="inputSuccess" class="width-100"
                                                        path="editor.id" value="${notice.editor.id}"/> <i
                                ...
                                <c:choose>
                                    <c:when test="${notice.fileId ==''||notice.fileId ==null}">
                                        <div class="form-group has-success">
                                            <label for="inputSuccess"
...
<script src="assets/js/atits-js/notice_add.js"></script>
