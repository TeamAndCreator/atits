...
<head>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<form:form id="defaultForm"
								   action="${pageContext.request.contextPath}/station_save"
								   modelAttribute="station" method="POST"
								   class="form-horizontal" role="form">
							<c:if test="${station.id != 0}">
								<form:hidden path="id" />
								<input type="hidden" name="_method" value="PUT">
							</c:if>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									   for="form-field-1">综合试验站</label>
								<div class="col-sm-4">
									<form:input type="text" path="staName"
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									   for="form-field-2"> 综合试验站站长</label>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									   for="form-field-1-1"> 综合试验站基本信息 </label>
								<div class="col-sm-4">
							...
							<%--<div class="clearfix form-actions">--%>
								...
								<%--<div class="col-md-offset-3 col-md-9">--%>
									<%--<c:choose>--%>
										<%--<c:when test="${person.role.permission == 1}">--%>
											<%--<button class="btn btn-info" type="submit">--%>
												<%--<i class="ace-icon fa fa-check bigger-110"></i>提交--%>
											<%--</button>--%>
										<%--</c:when>--%>
	...
	<script src="assets/js/atits-js/station_add.js"></script>
	</body>
