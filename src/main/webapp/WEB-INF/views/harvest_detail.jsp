                            ...
                            <div class="well">
                                <c:choose>
                                    <c:when test="${person.permission==1}">
                                        <ul class="pager">
                                            ...
                                            <li class="next bigger-120">
                                                <a href="harvest_setting?id=${harvest.id}"><i
                                    ...
                                    <c:when test="${person.permission==2}">
                                        <ul class="pager">
                                            <c:if test="${harvest.system.id==person.system.id && harvest.state!=0 && harvest.editor.system.id==person.system.id}">
                                                <li class="next bigger-120">
                                                    <a href="harvest_setting/${harvest.id}"><i
                                                            class="ace-icon fa fa-pencil"></i> 修改</a>
                                                </li>
                                            </c:if>
                                            <li class="previous bigger-120">
                                ...
                                <div class="col-md-11"
                                     style="float: none;display: block;margin-left: auto;margin-right: auto;">
                                    <div class="space"></div>
                                    <%--<div class="widget-main">${harvest.content}</div>--%>
