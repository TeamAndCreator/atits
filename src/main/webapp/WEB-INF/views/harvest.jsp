...
<head>
    ...
    <meta charset="utf-8"/>
    <title>重大成果</title>
    <meta name="description" content="Static &amp; harvest Tables"/>
    <meta name="viewport"
                        ...
                        <c:choose>
                            <c:when test="${person.permission ==1}">
                                <div class="action-buttons">
                                    <a class="btn btn-sm btn-primary" href="harvest_add"> <i
                                        ...
                                        <tr>
                                            <td class="center col-md-1 subcheck"><label
                                                    class="position-relative"> <input type="checkbox"
                                                                                      ...
                                                                                      value="${harvest.id}"/> <span
                                                    class="lbl"></span>
                                            </label></td>

                                            <td><a href="harvest_detail?id=${harvest.id}" role="button"
                                                   class="blue" data-toggle="modal">${harvest.title}</a>
                                            </td>
                                            <td>${harvest.system.sysName}</td>
                                            <td>${harvest.time}</td>

                                            <c:choose>
                                                <c:when test="${harvest.state==0}">
                                                    <td class="hidden-480">
                            ...
                            <c:when test="${person.permission ==2}">
                                ...
                                <table id="sample-table-1" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach items="${harvests}" var="harvest">
                                        <c:if test="${harvest.state==1 || harvest.system.id==person.system.id && harvest.editor.system.id==person.system.id}">
                                            <tr>
                                                <c:choose>
                                                    <c:when test="${harvest.system.id==person.system.id && harvest.state!=0 && harvest.editor.system.id==person.system.id}">
                                                        <td class="center col-md-1 subcheck"><label
                                                                class="position-relative"> <input type="checkbox"
                                                                                                  class="ace"
                                                                                                  name="subcheck"
                            ...
                            <c:otherwise>
                                <table id="sample-table-3" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach items="${harvests}" var="harvest">
                                        <c:if test="${harvest.state == 1 && harvest.system.id==1 || harvest.state == 1 && harvest.system.id == person.system.id}">
                                            <tr>
                                                <td></td>
                                                <td><a href="harvest_detail?id=${harvest.id}" role="button"
                                                       class="blue" data-toggle="modal">${harvest.title}</a>
...
<!-- 引入js -->
<script src="assets/js/atits-js/harvest.js"></script>
</body>
</html>
