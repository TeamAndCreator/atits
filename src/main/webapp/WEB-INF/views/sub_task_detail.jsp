        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="sys_task?sysId=${taskNum.sysId}">体系任务</a>
                    </li>
                    <li class="active">任务安排</li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="error-container">
                                <div class="well">
                                    ...
                                    <ul class="pager">
                                        <c:if test="${person.permission == 2}">
                                            <li class="next bigger-120">
                                                <a href="sub_task_setting?subTaskId=${subTask.id}"><i
                                    ...
                                    <div class="col-md-11"
                                        ...
                                        <h1 class="header smaller lighter blue">任务详情</h1>
                                        ...
                                        <div>
                                            ...
                                            <ul class="list-unstyled spaced inline bigger-150 margin-20">
                                                ...
                                                <div style="display: block; padding-left: 3em;">
                                                    ${subTask.startDate}&nbsp至&nbsp${subTask.endDate}
                                                </div>

                                                <li><i class="ace-icon fa fa-hand-o-right blue"></i>
                                                    <font color="#0088CC"> 所属任务：</font>
                                                </li>
                                                <div style="display: block; padding-left: 3em;">${subTask.task.title}</div>

                                                <li><i class="ace-icon fa fa-hand-o-right blue"></i>
                                                    <font color="#0088CC"> 任务内容：</font>
                                                </li>
                                                <div style="display: block; padding-left: 3em;">${subTask.content}</div>

                                                <br/><br/>

                                                <c:if test="${ !empty files}">
                                                    <li><i class="ace-icon fa fa-cloud-download  red"></i>
                                                        <font color="red"> 相关文件下载：</font>
                                                    </li>
                                                    ...
                                                    <c:forEach items="${files}" var="file">
                                                        <div style="display: block; padding-left: 3em;"
                                                             class="smaller-80"><a
                                                                href="files_download/${file.id}">${file.title}</a>
                                                        </div>
                                                    </c:forEach>
                                                </c:if>
                                            </ul>
