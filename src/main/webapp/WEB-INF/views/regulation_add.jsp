			...
			<div class="page-content-area">
				...
				<div class="row">
					<div class="col-xs-12">
						<!-- PAGE CONTENT BEGINS -->
						<form:form
								action="${pageContext.request.contextPath}/regulation_save"
								method="POST" class="form-horizontal" id="sample-form"
								modelAttribute="regulation">
							<c:if test="${regulation.id != 0}">
							...
							<div class="form-group has-success">
								...
								<c:choose>
									<c:when test="${regulation.id ne 0}">
										<div class="col-xs-12 col-sm-5">
										<span class="block input-icon input-icon-right">
                                            <input type="text" class="width-100 " value="${regulation.editor.name}"
												   disabled="true"/>
                                            <form:input type="hidden" id="inputSuccess" class="width-100 "
														path="editor.id" value="${regulation.editor.id}"/> <i
							...
							<c:choose>
								<c:when test="${rugulation.fileId ==''||rugulation.fileId ==null}">
									<div class="form-group has-success">
										<label for="inputSuccess"
						...
						<div class="col-md-11 col-lg-10" style=" float: none;display: block;margin-left: auto;margin-right: auto;  ">
							...
							<div class="widget-toolbox padding-4 clearfix">
								...
								<div class="btn-group pull-right">
									<c:choose>
										<c:when test="${person.permission == 1}">
											<button class="btn btn-sm btn-danger btn-white btn-round " id="add">
...
<script src="assets/js/atits-js/regulation_add.js"></script>
</body>
</html>
